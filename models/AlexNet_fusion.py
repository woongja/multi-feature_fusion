...
class FusionNet(nn.Module):
    def __init__(self, num_classes, branch_output_dim=1024, spec_shape=(1,128,126), mfcc_shape=(1,13,126), f0_len=126):
        super().__init__()
